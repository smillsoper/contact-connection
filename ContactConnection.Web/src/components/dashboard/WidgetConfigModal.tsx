...
export default function WidgetConfigModal({ title, initial, onSave, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={onClose}>
      ...
      >
        ...
        <p className="text-xs text-gray-500 mb-4">Filter which agents this widget shows. Pick one — the most specific wins.</p>
