...
export default function SetCustomFieldNode({ data, selected }: NodeProps & { data: NodeData }) {
  ...
  return (
    <NodeShell type="set_custom_field" label={data.label as string} isEntry={data.isEntry as boolean} selected={selected}>
