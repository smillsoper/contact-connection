...
function PlayNodeEditor({
  ...
  // Shared, cached clip list — the <AudioPicker> below reads the same store, so an upload or
  // recording there shows up in the periodic-announcement playlist immediately.
