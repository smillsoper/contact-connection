...
{
    /// <inheritdoc />
    public partial class AddTenantApiEndpoints : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "tenant_api_endpoints",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tenant_api_endpoints", x => x.id);
                });

            migrationBuilder.CreateIndex(
                name: "ix_tenant_api_endpoints_definition_id",
