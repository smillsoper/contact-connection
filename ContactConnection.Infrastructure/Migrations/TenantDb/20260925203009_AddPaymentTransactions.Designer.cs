...
namespace ContactConnection.Infrastructure.Migrations.TenantDb
{
    ...
    [Migration("20260925203009_AddPaymentTransactions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContactConnection.Domain.Entities.AgentStateHistoryEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("CustomCodeId")
                        .HasColumnType("uuid")
                        .HasColumnName("custom_code_id");
                    ...
                    b.HasIndex("AgentId", "EnteredAt");

                    b.HasIndex("TenantId", "EnteredAt");

                    b.ToTable("agent_state_history", (string)null);
                });
            ...
            modelBuilder.Entity("ContactConnection.Domain.Entities.AudioFile", b =>
                {
                    ...
                    b.Property<string>("TtsProviderKey")
                        .HasMaxLength(63)
                        .HasColumnType("character varying(63)")
                        .HasColumnName("tts_provider_key");

                    b.Property<string>("TtsSourceText")
                        .HasColumnType("text")
                        .HasColumnName("tts_source_text");
            ...
            modelBuilder.Entity("ContactConnection.Domain.Entities.CallStateHistoryEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("AbandonLength")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
                        .HasColumnName("abandon_length");

                    b.Property<string>("AbandonType")
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
                    ...
                    b.Property<bool?>("MetServiceLevel")
                        .HasColumnType("boolean")
                        .HasColumnName("met_service_level");
                    ...
                    b.HasIndex("TenantId", "CampaignId", "EnteredAt");

                    b.ToTable("call_state_history", (string)null);
                });
            ...
            modelBuilder.Entity("ContactConnection.Domain.Entities.Campaign", b =>
                {
                    ...
                    b.Property<string>("RingStrategy")
                        ...
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
                        .HasColumnName("ring_strategy");

                    b.Property<int>("RingTopN")
                        .HasColumnType("integer")
                        .HasColumnName("ring_top_n");

                    b.Property<int?>("SensitiveDataRetentionMinutes")
                        .HasColumnType("integer")
                        .HasColumnName("sensitive_data_retention_minutes");

                    b.Property<int>("ServiceLevelThresholdSeconds")
                        .HasColumnType("integer")
                        .HasColumnName("service_level_threshold_seconds");

                    b.Property<int>("ShortAbandonThresholdSeconds")
                        .HasColumnType("integer")
                        .HasColumnName("short_abandon_threshold_seconds");
            ...
            modelBuilder.Entity("ContactConnection.Domain.Entities.Offer", b =>
                {
                    ...
                    b.HasIndex("TenantId", "ProductId", "ClientId", "CampaignId")
                        .HasDatabaseName("ix_offers_scope");
            ...
            modelBuilder.Entity("ContactConnection.Domain.Entities.PaymentTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ResponseReasonText")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("response_reason_text");
                    ...
                    b.HasIndex("CallRecordId")
                        .HasDatabaseName("ix_payment_transactions_call_record_id");
            ...
            modelBuilder.Entity("ContactConnection.Domain.Entities.ScheduledCallback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("CallbackNumber")
                        ...
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
                        .HasColumnName("callback_number");

                    b.Property<string>("CallerIdOverride")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("caller_id_override");
                    ...
                    b.Property<Guid?>("OutboundCallRecordId")
                        .HasColumnType("uuid")
                        .HasColumnName("outbound_call_record_id");
                    ...
                    b.Property<Guid?>("TargetCampaignId")
                        .HasColumnType("uuid")
                        .HasColumnName("target_campaign_id");

                    b.Property<Guid?>("TargetFlowId")
                        .HasColumnType("uuid")
                        .HasColumnName("target_flow_id");
                    ...
                    b.HasIndex("CallRecordId")
                        .HasDatabaseName("idx_scheduled_callbacks_call_record");

                    b.HasIndex("CampaignId", "Status")
                        .HasDatabaseName("idx_scheduled_callbacks_campaign_status");

                    b.HasIndex("Status", "ScheduledFor")
                        .HasDatabaseName("idx_scheduled_callbacks_status_scheduled");

                    b.ToTable("scheduled_callbacks", (string)null);
                });
            ...
            modelBuilder.Entity("ContactConnection.Domain.Entities.StoredValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TenantId", "Scope", "ScopeId", "KeyName")
                        .IsUnique()
                        .HasDatabaseName("ix_stored_values_tenant_scope_key_unique");

                    b.ToTable("stored_values", (string)null);
                });
