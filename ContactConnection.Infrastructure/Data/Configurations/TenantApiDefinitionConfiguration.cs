...
public class TenantApiDefinitionConfiguration : IEntityTypeConfiguration<TenantApiDefinition>
{
    public void Configure(EntityTypeBuilder<TenantApiDefinition> builder)
    {
        builder.ToTable("tenant_api_definitions");
