...
public class PortalApiDefinitionConfiguration : IEntityTypeConfiguration<PortalApiDefinition>
{
    public void Configure(EntityTypeBuilder<PortalApiDefinition> builder)
    {
        ...
        builder.HasIndex(d => d.ApiCategory).HasDatabaseName("ix_portal_api_definitions_api_category");
        builder.HasIndex(d => new { d.ApiCategory, d.IsActive }).HasDatabaseName("ix_portal_api_definitions_api_category_active");
    }
}
