...
public class TenantApiEndpointConfiguration : IEntityTypeConfiguration<TenantApiEndpoint>
{
    public void Configure(EntityTypeBuilder<TenantApiEndpoint> builder)
    {
        builder.ToTable("tenant_api_endpoints");
        ...
        builder.HasIndex(e => e.DefinitionId).HasDatabaseName("ix_tenant_api_endpoints_definition_id");
        builder.HasIndex(e => e.ApiSubType).HasDatabaseName("ix_tenant_api_endpoints_api_sub_type");
    }
}
